      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?php echo base_url('panel_admin')?>" class="app-brand-link">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="<?php echo base_url('panel_admin')?>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?php echo base_url('admin/list_alumni')?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div data-i18n="Account Settings">Alumni</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?php echo base_url('perusahaan')?>" class="menu-link">
                <i class="menu-icon tf-icons bx bxs-factory"></i>
                <div data-i18n="Authentications">Perusahaan</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?php echo base_url('underconstruction')?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-archive"></i>
                <div data-i18n="Boxicons">Arsip MoU</div>
              </a>
            </li>
            <li class="menu-header small text-uppercase">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php echo base_url('pertanyaan')?>" class="menu-link">
                    <div data-i18n="Basic">Data Survey</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo base_url('surveyalumni')?>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?php echo base_url('testimoni/admin_index')?>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?php echo base_url('usermanagement')?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user-circle"></i>
                <div data-i18n="Tables">Users Managements</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?php echo base_url('pengaturan')?>" class="menu-link">
